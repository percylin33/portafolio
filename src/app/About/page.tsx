...
const About = () => {
    return <div className="bg-gray-100 flex items-center h-screen w-screen"> 
      ...
      <div className="w-1/2">
        <p className="  pl-8  text-4xl font-bold ">SOBRE MI EXPERIENCIA ACADEMICA </p>
        <p className=" p-8  text-xl">Mi historia con la tecnología comenzó en 2018, en la Universidad Tecnológica del Perú (UTP). Allí tuve la oportunidad de explorar diversos lenguajes de programación, como Java, HTML, CSS, PHP, JavaScript y MySQL. Estas experiencias despertaron en mí una pasión por la programación que no había sentido antes.
